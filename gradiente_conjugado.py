import numpy as np
from problema_direto import problema_direto, pseudo_dados, problema_adjunto, problema_sensibilidade
...
def gradiente_conjugado(eps, u_0=np.ones(N), version='fs'):
    i = 0
    u = u_0
    P0 = np.array([P0])
    i_max = 100
    ...
    while (i < i_max):
        # Step 1
        t, T1, T2 = problema_direto(u, T1=1.0, T2=1.0)
        ...
        t, L1, L2 = problema_adjunto(L1_0, L2_0, T1, T2, Y1, Y2)
        ...
        t, delta_T1, delta_T2 = problema_sensibilidade()
    return